...
exports.createFromObject = exports.createUsingFile = exports.FeatureCollection = void 0;
...
var FeatureCollection = /** @class */ (function () {
    function FeatureCollection(x, filePath) {
        ...
        this.update = function (update, feature) {
    ...
    FeatureCollection.prototype.Find = function (feature) {
        var _a, _b;
        if (feature === undefined) {
            ...
            return this.FindByProperty((feature === null || feature === void 0 ? void 0 : feature.properties) || {});
        }
        else if (feature.properties === null) {
            return this.FindByGeometry((feature === null || feature === void 0 ? void 0 : feature.geometry) || {});
        }
        else {
            return this.data.features.filter(function (f) {
                var _a;
                if (f.geometry.type !== ((_a = feature.geometry) === null || _a === void 0 ? void 0 : _a.type)) {
                    return false;
                }
    ...
    FeatureCollection.prototype.FindByProperty = function (x) {
        return this.data.features.filter(function (f) {
    ...
    FeatureCollection.prototype.FindByGeometry = function (d) {
        return this.data.features.filter(function (f) { return f.geometry.type === (d === null || d === void 0 ? void 0 : d.type); });
    };
    ...
    FeatureCollection.prototype.GetAllFeatures = function () {
        return this.data.features;
    };
    FeatureCollection.prototype.Update = function (update, feature) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 5, , 6]);
                        if (!realpath) return [3 /*break*/, 3];
                        return [4 /*yield*/, fs.writeFile(realpath, JSON.stringify(this.data))];
                    case 2:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 3: throw "Pass location where you want to save the file";
...
var createFromObject = function (data) {
